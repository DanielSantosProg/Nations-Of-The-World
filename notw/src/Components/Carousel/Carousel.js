...
function CarouselSlide() {
  return (
    <div className="h-56 max-w-screen-sm sm:h-64 xl:h-80 2xl:h-96">
        ...
        <div className="relative text-center">
          <Link to="country/japan" className="block relative">
            <img
              ...
              className="max-w-max h-auto"
            />
            <p className="absolute inset-0 flex items-center justify-center font-bold text-red-700 underline decoration-double backdrop-filter backdrop-saturate-50 hover:backdrop-saturate-200">
              Japan
            </p>
          </Link>
        </div>
        <div className="relative text-center">
          <Link to="country/netherlands" className="block relative">
            <img
              ...
              className="max-w-max h-auto"
            />
            <p className="absolute inset-0 flex items-center justify-center font-bold text-sky-400 underline decoration-double outline-cyan-500 backdrop-filter backdrop-saturate-50 hover:backdrop-saturate-200">
              Netherlands
            </p>
          </Link>
        </div>
